 ...
 * {@link ActivityInVerifyFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ActivityInVerifyFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ActivityInVerifyFragment extends Fragment implements CustomRecyclerView.DataOperation ,CardLayoutOneAdapter.OnItemClickListener{
    ...
    public ActivityInVerifyFragment() {
        //要求要有一个空的构造函数
    }
     ...
     * Activity->Fragment
     */
    public static ActivityInVerifyFragment newInstance(String values) {
        ActivityInVerifyFragment fragment = new ActivityInVerifyFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(rootView==null) {
            rootView = inflater.inflate(R.layout.fragment_activity_in_verify, container, false);
            init(rootView);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onActivityInVerifyFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        void onActivityInVerifyFragmentInteraction(Uri uri);
    }
}
