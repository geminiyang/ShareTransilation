...
public class AttentionFragment extends Fragment implements FansAndAttentionAdapter.OnItemClickListener,
     ...
     * Activity->Fragment
     */
    public static AttentionFragment newInstance(String values) {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onAttentionFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        void onAttentionFragmentInteraction(Uri uri);
    }
}
