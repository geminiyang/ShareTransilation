...
import com.idear.move.Adapter.CardLayoutTwoAdapter;
...
public class ActivityWaitForFeedBackFragment extends Fragment implements CustomRecyclerView.DataOperation,
    ...
    private LinkedList<CardLayoutTwoDataModel> dataModels = new LinkedList<>();
    ...
    public ActivityWaitForFeedBackFragment() {
        //要求要有一个空的构造函数
    }
     ...
     * Activity->Fragment
     */
    public static ActivityWaitForFeedBackFragment newInstance(String values) {
        ActivityWaitForFeedBackFragment fragment = new ActivityWaitForFeedBackFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(rootView==null) {
            rootView = inflater.inflate(R.layout.fragment_activity_wait_for_feedback, container, false);
            init(rootView);
    ...
    private void initRecyclerView(View view) {
        ...
        //初始化自定义适配器
        adapter = new CardLayoutTwoAdapter(getActivity(), dataModels);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onActivityWaitForFeedBackFragmentInteraction(uri);
        }
    }
    ...
    public void onLoadMore() {
        for (int i = 0; i < REQUEST_COUNT; i++) {
            ...
            dataModels.add(new CardLayoutTwoDataModel(activityName,picUrl,TimeStamp));
        }
    }
    ...
    public void onRefresh() {
        for (int i = 0; i < REQUEST_COUNT; i++) {
            ...
            dataModels.addFirst(new CardLayoutTwoDataModel(activityName,picUrl,TimeStamp));
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        void onActivityWaitForFeedBackFragmentInteraction(Uri uri);
    }
}
