 ...
 * {@link ActivityFinishFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ActivityFinishFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ActivityFinishFragment extends Fragment implements CustomRecyclerView.DataOperation,
     ...
     * Activity->Fragment
     */
    public static ActivityFinishFragment newInstance(String values) {
        ActivityFinishFragment fragment = new ActivityFinishFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(rootView==null) {
            rootView = inflater.inflate(R.layout.fragment_activity_finish, container, false);
            init(rootView);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onActivityFinishFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        void onActivityFinishFragmentInteraction(Uri uri);
    }
}
