 ...
 * {@link MyFavoritesActivityFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MyFavoritesActivityFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MyFavoritesActivityFragment extends Fragment implements CustomRecyclerView.DataOperation,
     ...
     * Activity->Fragment
     */
    public static MyFavoritesActivityFragment newInstance(String values) {
        MyFavoritesActivityFragment fragment = new MyFavoritesActivityFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(rootView==null) {
            rootView = inflater.inflate(R.layout.fragment_my_favorites_activity, container, false);
            init(rootView);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onFavoritesActivityFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        void onFavoritesActivityFragmentInteraction(Uri uri);
    }
}
