 ...
 * {@link MyFavoritesDynamicsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MyFavoritesDynamicsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MyFavoritesDynamicsFragment extends Fragment implements CustomRecyclerView.DataOperation,
    ...
    public MyFavoritesDynamicsFragment() {
        //要求要有一个空的构造函数
    }
     ...
     * Activity->Fragment
     */
    public static MyFavoritesDynamicsFragment newInstance(String values) {
        MyFavoritesDynamicsFragment fragment = new MyFavoritesDynamicsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(rootView==null) {
            rootView = inflater.inflate(R.layout.fragment_my_favorites_dynamics, container, false);
            init(rootView);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onFavoritesDynamicsFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        void onFavoritesDynamicsFragmentInteraction(Uri uri);
    }
}
