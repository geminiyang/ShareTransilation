...
public class SpreadSearchFragment extends Fragment implements
        SpreadRvAdapter.OnItemClickListener,CustomRecyclerView.DataOperation {

    private OnFragmentInteractionListener mListener;
    private static final String ARG = "arg";

    public static SpreadSearchFragment newInstance(String arg){
        SpreadSearchFragment fragment = new SpreadSearchFragment();
    ...
    private void initRecyclerView(View view) {
        ...
        //初始化自定义适配器
        adapter = new SpreadRvAdapter(view.getContext(), dataModels);
    ...
    public void onItemClick(int position) {
        IntentSkipUtil.skipToNextActivity(getActivity(), SpreadDetailActivity.class);
    }
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onSpreadSearchFragmentInteraction(uri);
        }
    }
    /**
    ...
    public interface OnFragmentInteractionListener {
        void onSpreadSearchFragmentInteraction(Uri uri);
    }
}
