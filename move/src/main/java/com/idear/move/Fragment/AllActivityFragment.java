...
public class AllActivityFragment extends Fragment {
    ...
    public static AllActivityFragment newInstance(String arg){
    ...
    private int[] types = {AllActivityRvAdapter.TYPE_ONE,AllActivityRvAdapter.TYPE_TWO,
            AllActivityRvAdapter.TYPE_THREE};
            ...
            public void onClick(View v) {
                if (adapter.getItemCount() !=usernames.length) {
                    dataModels.add(new AllActivityDataModel(titles[adapter.getItemCount()],
                            ...
                            visitNum[adapter.getItemCount()], types[adapter.getItemCount()]));
                    //更新视图(添加数据项)
