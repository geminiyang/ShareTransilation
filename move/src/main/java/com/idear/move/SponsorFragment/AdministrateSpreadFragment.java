 ...
 * {@link AdministrateSpreadFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AdministrateSpreadFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AdministrateSpreadFragment extends Fragment implements CustomRecyclerView.DataOperation,
    ...
    public AdministrateSpreadFragment() {
        //要求要有一个空的构造函数
    }
     ...
     * Activity->Fragment
     */
    public static AdministrateSpreadFragment newInstance(String values) {
        AdministrateSpreadFragment fragment = new AdministrateSpreadFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(rootView==null) {
            rootView = inflater.inflate(R.layout.fragment_administrate_spread, container, false);
            init(rootView);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onAdministrateSpreadFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        void onAdministrateSpreadFragmentInteraction(Uri uri);
    }
}
