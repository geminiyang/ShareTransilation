...
public class UpdateUserInfoThread extends Thread{
    ...
    public UpdateUserInfoThread(Context context, String url,String key,String value) {
		this.url = url;
    ...
    private void updateUserInfo() {
        try {
            ...
            jsonObject.put("user_id", CookiesSaveUtil.getUserId(mContext));
            if(TextUtils.equals(key,"sex")) {
