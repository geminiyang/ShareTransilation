...
public class LoadMoreThread extends Thread {
    ...
    public LoadMoreThread(DataGetInterface mListener, LinkedList<MyDynamicsDataModel> list) {
    ...
    public void run() {
        ...
        for (int i = 0; i < REQUEST_COUNT; i++) {
            ...
            Logger.d("loadMode---"+index+"---LIST SIZE : " + (dataModels.size()+1));
            dataModels.add(new MyDynamicsDataModel(userIcons[index],"上拉加载",
