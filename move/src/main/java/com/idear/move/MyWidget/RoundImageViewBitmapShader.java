...
public class RoundImageViewBitmapShader extends ImageView {
    ...
    public RoundImageViewBitmapShader(Context context, AttributeSet attrs) {
        super(context, attrs);
        mMatrix = new Matrix();
    ...
    private Bitmap drawableToBitmap(Drawable drawable) {
        ...
        //将drawable绘制在canvas上，canvas用bitmap初始化过
