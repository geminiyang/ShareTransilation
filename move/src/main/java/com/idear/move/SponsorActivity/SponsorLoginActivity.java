...
public class SponsorLoginActivity extends BaseActivity implements LoaderCallbacks<Cursor> {

    /**
     * 确认READ_CONTACTS权限的ID.
     */
    ...
    private void initEvent() {
        ...
        start.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                IntentSkipUtil.skipToNextActivity(SponsorLoginActivity.this, SponsorRegisterActivity.class);
            }
        });
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(SponsorLoginActivity.this,
