...
public class CardLayoutTwoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private List<CardLayoutTwoDataModel> modelList;
    ...
    public CardLayoutTwoAdapter(Context context , List<CardLayoutTwoDataModel> modelList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // 给ViewHolder设置布局文件
        View v = mInflater.inflate(R.layout.card_layout_two, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        // 给ViewHolder设置元素
        CardLayoutTwoDataModel u = modelList.get(position);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        private TextView mActivityName,mTime;
        private Button mWriteFeedBack;
        private ImageView mActivityPic;

        private ViewHolder(View v) {
            super(v);
            mActivityName = (TextView) v.findViewById(R.id.activityName);
            mWriteFeedBack = (Button) v.findViewById(R.id.writeFeedBack);
