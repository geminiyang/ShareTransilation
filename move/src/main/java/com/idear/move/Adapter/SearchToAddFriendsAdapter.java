...
import com.idear.move.myWidget.RoundImageViewBitmapShader;
...
public class SearchToAddFriendsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public static int BTN = 1;

    private Context mContext;
    private List<SearchToAddFriendsDataModel> modelList;
    ...
    public SearchToAddFriendsAdapter(Context context , List<SearchToAddFriendsDataModel> modelList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // 给ViewHolder设置布局文件
        View v = mInflater.inflate(R.layout.card_layout_search_to_add_friends, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        // 给ViewHolder设置元素
        SearchToAddFriendsDataModel u = modelList.get(position);
