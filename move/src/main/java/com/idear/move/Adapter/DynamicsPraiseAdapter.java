...
public class DynamicsPraiseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private List<DynamicsPraiseDataModel> modelList;
    ...
    public DynamicsPraiseAdapter(Context context , List<DynamicsPraiseDataModel> modelList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // 给ViewHolder设置布局文件
        View v = mInflater.inflate(R.layout.carview_layout_praise, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        // 给ViewHolder设置元素
        DynamicsPraiseDataModel u = modelList.get(position);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        private TextView mUsername,mBreviaryContent;
